...
public class GetListeningSessionByTypeResult {
    private final List<ListeningSessionModel> listeningSessions;

    private GetListeningSessionByTypeResult(List<ListeningSessionModel> listeningSessions) {
    ...
    public static class Builder{
        ...
        public GetListeningSessionByTypeResult build() { return new GetListeningSessionByTypeResult(listeningSessions);}
    }
}
